...
def video_keypoints(matcher, cap=cv2.VideoCapture('../images/traffic.mp4'),
...
FLANN_INDEX_LSH = 6
index_params = dict(algorithm=FLANN_INDEX_LSH, table_number=20, key_size=15,
                    multi_probe_level=2)
search_params = dict(check=10)
