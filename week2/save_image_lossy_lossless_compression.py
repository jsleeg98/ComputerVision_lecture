...
parser.add_argument('--out_png', default='../images/lena_compressed.png', help='Output image path for lossless result')
parser.add_argument('--out_jpg', default='../images/lena_compressed.jpg', help='Output image path for lossy result')
