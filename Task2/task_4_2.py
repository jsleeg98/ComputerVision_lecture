...
opt_flow = cv2.calcOpticalFlowFarneback(img1, img2, None, 0.5, 5, 13, 10, 5, 1.1, cv2.OPTFLOW_FARNEBACK_GAUSSIAN)

display_flow(img2, opt_flow)  # Farneback

flow_DualTVL1 = cv2.createOptFlow_DualTVL1()
opt_flow = flow_DualTVL1.calc(img1, img2, None)

display_flow(img2, opt_flow)  # DualTVL1 Optical Flow
