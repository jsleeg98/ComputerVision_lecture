...
detect_faces('./faces.mp4', haar_face_cascade, 'Haar cascade face detector')

lbp_face_cascade = cv2.CascadeClassifier()
lbp_face_cascade.load('./lbpcascade_frontalface.xml')

detect_faces('./faces.mp4', lbp_face_cascade, 'LBP cascade face detector')
